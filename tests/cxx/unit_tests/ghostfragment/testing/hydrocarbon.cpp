...
TEST_CASE("hydrocarbon_generator") {
    SECTION("Methane (1 carbon)") {
        REQUIRE(AreMoleculesEqual(Methane(), hydrocarbon(1)));
    }
    SECTION("Ethane (2 carbon)") {
        REQUIRE(AreMoleculesEqual(Ethane(), hydrocarbon(2)));
    }
    SECTION("Propane (3 carbon)") {
        REQUIRE(AreMoleculesEqual(Propane(), hydrocarbon(3)));
    }
}

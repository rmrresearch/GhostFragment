...
// using connectivity_pt = ghostfragment::ConnectivityTable;
...
//     return pluginplay::make_lambda<connectivity_pt>([=](const auto& mol) {
//         REQUIRE(frags.supersystem() == mol);
//         return conns;
//     });
// }
...
// /* Testing Strategy:
//  *
//  * The module assumes that it's given disjoint fragments, and that
//  connectivity
//  * it gets back is correct. We test that we get the correct graph back for
//  the
...
//  * likes, then connections between nodes can be thought of as hydrogen bonds.
//  In

...
void createCarbons(Atom *atoms, int numCarbon, int *atomsCreated, float carbonBond, float angleDeg){
...
void positionCarbon(Atom *newCarbon, Atom *sourceCarbon, float carbonBond, float angleDeg){
...
void createHydrogens(Atom *atoms, int numCarbon, int *atomsCreated, float hydrogenBond, float angleDeg){
...
void positionHydrogen(Atom *newHydrogen, Atom *sourceCarbon, int flag, float hydrogenBond, float angleDeg){

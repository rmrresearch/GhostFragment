...
// std::array<float, 3> position_hydrogen(const std::vector<float>&
// source_coords,
//                                        int flag, int num, float
//                                        hydrogen_bond, float angle_deg) {
//     // Creates the pointer for positions
//     std::array<float, 3> coords{0.0, 0.0, 0.0};
//     // Convert degrees to radians
//     float angle_rad = angle_deg * (3.14159 / 180);

//     // Because multiple hydrogen atoms get the same carbon atom, they need to
//     be
...
//             // If the carbon atom is odd, the hydrogen must be above,
//             otherwise,
//             // it must be below
//             coords[1] *= (num % 2 == 0) ? -1 : 1;
//             break;

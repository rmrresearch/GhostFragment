...
//  * really need to test here is the data flow, namely that the driver calls
//  the
...
//             for(const auto& frag_i : water_n) capped.emplace(frag_i,
//             empty_set);
...
//                 // The module doing the screening, just matters it returns
//                 nmers auto screen_mod = pluginplay::make_lambda<screener_t>(
...
//                         REQUIRE_THROWS_AS(mod.run_as<my_pt>(water_n),
//                         error_t);
//                     }
//                 }
//             }

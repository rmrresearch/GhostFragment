...
from ghostfragment import ghostfragment
from friendzone import friendzone
...
class MySTO3G(pluginplay.ModuleBase):
    ...
    def run_(self, inputs, submods):
        ...
        aos = chemist.orbital_space.AOSpaceD(sto3g(mol))
        rv = self.results()
        return simde.AtomicOrbitals.wrap_results(rv, aos)

class TestWaterClusterMBE(unittest.TestCase):
    def setUP(self):
        mm.add_module("STO-3G", make_shared[MySTO3G]())

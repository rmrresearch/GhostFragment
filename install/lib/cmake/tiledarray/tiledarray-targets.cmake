...
# Create imported target TiledArray_Eigen
add_library(TiledArray_Eigen INTERFACE IMPORTED)

set_target_properties(TiledArray_Eigen PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/opt/homebrew/include/eigen3"
)

# Create imported target TiledArray_UMPIRE
add_library(TiledArray_UMPIRE INTERFACE IMPORTED)
...
add_library(tiledarray SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/tiledarray-targets-*.cmake")

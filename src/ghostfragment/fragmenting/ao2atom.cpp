...
// This module will map each center to the atom it is closest to. This algorithm
// is not suitable for use when centers are not atom-centered (*e.g.*, ghost
// atoms, and mid-bond functions).

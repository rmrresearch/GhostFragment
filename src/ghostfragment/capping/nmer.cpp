...
// AFAIK most capping methods are defined for fragments and the generalization
// to n-mers is assumed. This module assumes this is the case and ultimately
// calls a capping routine which works on fragments. Thus this module actually
// caps the n-mers by:
...
// n-mer to the set of atoms comprising that fragment, and taking the union of
// all such sets of atoms.
// )""";
...
//     using frags_type = std::decay_t<typename
//     capped_frags_traits::input_type>; using frag_type  = typename
//     frags_type::value_type;

//     using capped_nmers_traits = pt::CappedNMersTraits;
//     using nmers_type  = std::decay_t<typename
//     capped_nmers_traits::input_type>; using nmer_type   = typename
//     nmers_type::value_type; using return_type = typename
//     capped_nmers_traits::result_type;

...
inline void set_defaults(pluginplay::ModuleManager& mm) {
    // mm.change_submod("Fragment Driver", "Pseudoatoms", "Heavy Atom
    // Partition"); mm.change_submod("Fragment Driver", "Molecular graph",
    // "Molecular graph"); mm.change_submod("Fragment Driver", "Molecular graph
    // to fragments",
    //                  "Cluster Partition");

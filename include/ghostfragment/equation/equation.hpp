...
#include <ghostfragment/type/fragmented.hpp>

/** @brief Namespace for classes and methods pertaining to formulating composite
 *         methods.
 *
 */
namespace ghostfragment::equation {

/** @brief Makes a Term where the chemical system and aos come from a fragmented
 *         chemical system.
 *
 */

...
// /// Used to conveniently propagate types associated with FragmentedMolecule
// PT struct InputQueueTraits {
//     /// Expected input type of the molecular system
//     using system_type = chemist::ChemicalSystem;

//     /// How the fragmented system is returned.
//     using result_type = std::vector<std::pair<chemist::ChemicalSystem,
//     double>>;
// };

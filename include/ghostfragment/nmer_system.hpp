...
//  *         fragments.
//  *
//  *  This class models a view of a supersystem after it has been decomposed
//  into
//  *  unions of fragments, i.e., n-mers. The n-mers remember their history
//  (i.e.,
//  *  know which fragments formed them) and the fragments are accessible as
//  well.
//  *
//  */
// class NMerSystem {
...
//     /// Type of a read-only reference to a subset of the supersystem's AO
//     basis using ao_set_type = fragmented_system_type::ao_set_type;
...
//     // using nmer_type = typename nmer_set_type::reference_type;
...
//      *  placeholder. The resulting instance functions like an empty
//      container.
//      *  The only way to add N-mers to the resulting instance is to assign to
//      it
...
//      *  optimizations. It's exposed so: we don't have to rely on friendship
//      to
...
//     /** @brief Move ctor
//      *
//      *  This ctor will create a new NMerSystem by taking ownership of the
//      state
//      *  contained in @p other.
//      *
//      *  @param[in,out] other The instance who's state is being taken. After
//      this
...
//      *
//      *  This operator will replace the state contained in the current
//      instance
//      *  (releasing it in the process) with a deep copy of the state contained
//      in
//      *  the @p rhs instance.
//      *
//      *  @param[in] rhs The instance whose state is being copied.
//      *
//      *  @return The current instance, after replacing its state with a copy
//      of
...
//      *
//      *  This operator will overwrite the state contained in the current
//      instance
//      *  (releasing it in the process) with the state contained in @p rhs.
//      *
//      *  @param[in,out] rhs the instance who's state is being taken. After
//      this
//      *                     call @p rhs will be in a state consistent with
//      being
//      *                     default initialized.
//      *
//      *  @return The current instance, after replacing its state with the
//      state
//      *          in @p rhs.
//      *
//      *  @throw None No throw guarantee.
...
//      *
//      *  @return The number of n-mers that the system has been fragmented
//      into.
//      *
//      *  @throw None No throw guarantee.
//      */
...
//      *  bit tricky. This function will create a new, empty n-mer and return
//      it.
//      *  The n-mer is linked to the set of fragments returned by
//      `fragments()`,
...
//      *
//      *
//      *  @param[in] i The 0-based offset of the requested n-mer. @p i must be
//      in
//      *               the range [0, size()).
//      *
...
//      *  instance. N.B. that this relies on type::nmers value comparison,
//      which
//      *  also verifies that n-mers are formed from the same fragments (and
//      those
...
//      *
//      *  @return A read-only reference to the original fragmented
//      representation
//      *          of the supersystem used to create the n-mers.
//      *
//      *  @throw std::runtime_error if the instance does not have a PIMPL.
//      Strong
//      *                            throw guarantee.
//      */
...
//      *
//      *  This function will flatten the provided n-mer into a set of atoms
//      (the
//      *  actual process simply takes the union of the atoms in each fragment
//      and
...
//      *
//      *  @param[in] nmer The set of fragments to determine the AO basis set
//      for.
//      *
//      *
//      *  @return The AO basis set for @p nmer.
//      *
//      *  @throw std::runtime_error if this instance does not have a PIMPL.
//      Strong
//      *                            throw guarantee.
//      *
//      *  @throw std::out_of_range if the fragments in @p nmer are not part of
//      the
...
//      *
//      *  This function will loop over the set of atoms in the provided
//      fragment
...
//      *
//      *  @param[in] frag The set of atoms to determine the AO basis set for.
//      The
//      *                  actual input does not need to be a fragment f
//      *                  used to create this instance. All that matters is
//      that
...
//      *
//      *  @param[in] nmer The set of fragments to compute the number of
//      electrons
//      *                  for. The actual input does not need to be an n-mer
//      found
...
//      *  @throw std::runtime_error if the instance does not contain a PIMPL.
//      *                            Strong throw guarantee.
//      *  @throw std::out_of_range if @p nmer is not formed from the same set
//      of
//      *                           fragments as the current instance. Strong
//      throw
//      *                           guarantee.
//      *
//      */
...
//  *  NMerSystem::operator== for details on how NMerSystem instances are
//  compared.
//  *
